...
// ── Helper ──
function reg(a: AgentDefinition): void { AGENT_REGISTRY.set(a.id, a); }
...
export function getAgentsByTeam(team: TeamId | 'command'): AgentDefinition[] {
...
export function getMakersByTeam(team: TeamId): AgentDefinition[] {
  return [...AGENT_REGISTRY.values()].filter(a => a.team === team && a.level === 'maker');
}

export function getCheckersByTeam(team: TeamId): AgentDefinition[] {
  return [...AGENT_REGISTRY.values()].filter(a => a.team === team && a.level === 'checker');
}

export function getCSuiteAgents(): AgentDefinition[] {
...
export function getAgentCount(): { total: number; command: number; csuite: number; makers: number; checkers: number } {
